      ...
      {yourDonationPercentage === 0 ? (
        ...
        <div>
          ...
          <div className="flex flex-col md:flex-row gap-4 lg:gap-[56px] mt-[0px] lg:mt-[-50px] px-[auto]">
            <div className="flex gap-4 items-center justify-center text-[20px] font-semibold">
              Your Donation: {yourDonations}{" "}
              <div className="w-[80px] h-[10px] bg-[#00C49F] "></div>
            </div>
            <div className="flex gap-4 items-center justify-center text-[20px] font-semibold">
              Total Donation: {totalDonations}{" "}
              <div className="w-[80px] h-[10px] bg-[#FF444A] "></div>
            </div>
          </div>
        </div>
      )}
